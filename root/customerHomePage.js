...
function what() {
    ...
    for (var i = 0; ; ++i) {
        ...
        bankname = contractInstance.getBankName.call(add);
        //alert(bankname);
        //alert(add);
